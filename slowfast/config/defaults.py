...
_C.MODEL.SINGLE_PATHWAY_ARCH = ["2d", "c2d", "i3d", "slow", "x3d", "mvit", "uniformer", "uniformerv2", "videomamba"]
...
_C.VIDEOMAMBA = CfgNode()
_C.VIDEOMAMBA.BACKBONE = "videomamba_middle"
_C.VIDEOMAMBA.N_DIM = 576
_C.VIDEOMAMBA.PRETRAIN = ''
