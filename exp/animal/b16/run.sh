...
python -X faulthandler tools/run_net.py \
  ...
  DATA.PATH_TO_DATA_DIR /mount/ccai_nas/yunzhu/Animal_Kingdom/action_recognition/annotation/classes/Bird/ \
  ...
  TEST.BATCH_SIZE 32 \
  RNG_SEED 6666 \
  OUTPUT_DIR "/mount/ccai_nas/yunzhu/Animal_Kingdom/output/b16_bird/"
