...
BATCH_SIZE=32
BASE_LR=1e-5
work_path=./exp/animal/pretrain_l14
...
python tools/run_net.py \
  ...
  TEST.BATCH_SIZE 128 \
  TEST.CHECKPOINT_FILE_PATH "/mount/ccai_nas/yunzhu/Animal_Kingdom/output/pretrain_l14/checkpoints/checkpoint_epoch_00065.pyth"
