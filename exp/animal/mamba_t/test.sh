...
python tools/run_net.py \
  ...
  TEST.BATCH_SIZE 128 \
  TEST.CHECKPOINT_FILE_PATH "/mount/ccai_nas/yunzhu/Animal_Kingdom/output/mamba/checkpoints/checkpoint_epoch_00085.pyth"
  RNG_SEED 6666 \
  OUTPUT_DIR "/mount/ccai_nas/yunzhu/Animal_Kingdom/output/mambai/"
