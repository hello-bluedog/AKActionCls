...
BATCH_SIZE=32
BASE_LR=1e-5
work_path=./exp/animal/umtvit_bias
...
python tools/run_net.py \
  ...
  TEST.BATCH_SIZE 64 \
  TEST.CHECKPOINT_FILE_PATH "/mount/ccai_nas/yunzhu/Animal_Kingdom/output/umtvit_bias/checkpoints/checkpoint_epoch_00085.pyth"
  RNG_SEED 6666 \
  OUTPUT_DIR "/mount/ccai_nas/yunzhu/Animal_Kingdom/output/umtvit_bias"
